...
}__deprecated_enum_msg("will be deprecated");
...
#define IP_ATTRIBUTE_OPERATOR_ID                "operatorid"//"operator_id"
#define IP_ATTRIBUTE_HEAD_ID                    "head_id"//"operator_id"
#define IP_ATTRIBUTE_FIXTURE_ID                 "fixture_id"//"operator_id"
#define IP_ATTRIBUTE_SWVERSION		            "sw_version"//"software_version"
...
#define IP_ATTRIBUTE_UNIT_NUMBER		 		"UNIT#"			       //ex: 120
...
#define IP_FAIL_INVALID_STATION_ID		    	"Station identifier invalid"
...
///Users/world/Desktop/LeftButtonFlexCompassSenorTest/LeftButtonFlexCompassSenorTest			
    ...
    ///set the test context items for the test
    ///@param testSpecHandle : the handle originally returned from IP_testSpec_create()
    ///@param cpTestContxt has to be the following format "Sequence1@Key7:Val7, Sequence2@Key2:Val2, rootKey:rootVal"
    ///"@" separates the dictionary and ":" separate the key value
    bool IP_testSpec_setTestContext( IP_TestSpecHandle testSpecHandle, const char* cpTestContxt ,size_t testContextLength);
    
	///set this item to be a 'non test item' - will only show in TSR and CSV 'Failed Tests' if is a failure
	///@param testSpecHandle : the handle originally returned from IP_testSpec_create()
	bool IP_testSpec_setAsNonTestItem( IP_TestSpecHandle testSpecHandle )__deprecated_msg ("IP_testSpec_setAsNonTestItem will be deprecated in next major revision");
	...
	IP_API_Reply IP_setDUTPosition(IP_UUTHandle handleDUTPosition,enum IP_ENUM_FIXTURE_ID eFixId,enum IP_ENUM_FIXTURE_HEAD_ID eHeadId) __deprecated_msg("IP_setDUTPosition will be deprecated in next major revision");
