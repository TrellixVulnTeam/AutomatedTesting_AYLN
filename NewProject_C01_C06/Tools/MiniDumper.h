...
int GenerateMiniDump(PEXCEPTION_POINTERS pExceptionPointers)
{
    ...
    //    TCHAR szVersion[] = _T("DumpFile");
    //    char szVersion[] = "DumpFile";
    SYSTEMTIME stLocalTime;
    GetLocalTime(&stLocalTime);
    wsprintf((LPWSTR)szFileName, L"DumpFile-%04d%02d%02d-%02d%02d%02d.dmp", stLocalTime.wYear, stLocalTime.wMonth,
             stLocalTime.wDay, stLocalTime.wHour, stLocalTime.wMinute, stLocalTime.wSecond);
    HANDLE hDumpFile = CreateFile((LPWSTR)szFileName, GENERIC_READ | GENERIC_WRITE, FILE_SHARE_WRITE | FILE_SHARE_READ,
                                  0, CREATE_ALWAYS, 0, 0);
